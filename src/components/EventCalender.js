...
const EventCalender = ({ events }) => {
  ...
  return (
    <div className="calendar-container">
      <h3 className="text-start">Upcoming Events</h3>
      <div className="filters-container d-flex flex-column flex-sm-row align-items-center mb-4">
        {/* Search Bar */}

        <div className="search-container mb-3 mb-sm-0">
          <label className="form-label mb-0">Search for Events:</label>
          <input
            type="text"
            placeholder="Search Events"
            value={searchTerm}
        ...
        {/* Date Selector */}
        <div className="date-container mb-3 mb-sm-0">
